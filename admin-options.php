...
$MTG_UTIL_DEFAULT_OPTIONS = array(
	'card_database_query_url' => 'http://magiccards.info/query?q=!',
...
//		update_option(MTG_UTIL_OPTIONS, $mtg_util_options);
	...
	function add_admin_menu_page() {
		...
		add_menu_page(MTG_UTIL_NAME . ' Options', MTG_UTIL_NAME . ' Options', 'manage_options', MTG_UTIL_PREFIX . 'options', array($this, 'options_page_content') );
