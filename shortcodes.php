...
$MTG_UTIL_DEFAULT_OPTIONS_AUTOCARD_URL = 'http://magiccards.info/query?q=!';
...
$MTG_UTIL_DEFAULT_OPTIONS_MANA_REGEX = "/(([2wubrgpc]\/[2wubrgpc])|[0-9]+|[a-z])/";
...
$MTG_UTIL_DEFAULT_OPTIONS_MANA_TRUE = array(
	...
	'w/p' => 'wp', 'p/w' => 'wp', 'u/p' => 'up', 'p/u' => 'up', 'b/p' => 'bp', 'p/b' => 'bp', 'r/p' => 'rp', 'p/r' => 'rp', 'g/p' => 'gp', 'p/g' => 'gp', 'p/2' => '2p', '2/p' => '2p',
	't' => 'tap', 'q' => 'untap', 's' => 'snow', 'e' => 'e', 'p' => 'p', 'h' => 'h', 'x' => 'x', 'y' => 'y', 'z' => 'z', 'i' => 'i',
...
class mtg_util_shortcodes{
	...
	function mana_shortcode($atts, $content) {
		...
		global $MTG_UTIL_DEFAULT_OPTIONS_MANA_REGEX, $MTG_UTIL_DEFAULT_OPTIONS_MANA_REPLACE, $MTG_UTIL_DEFAULT_OPTIONS_MANA_TRUE;
		...
		foreach($cost as $key => $value) {
			...
			if (isset($MTG_UTIL_DEFAULT_OPTIONS_MANA_TRUE[$value])) {
				$url = plugins_url("{$MTG_UTIL_DEFAULT_OPTIONS_MANA_TRUE[$value]}.jpg", __FILE__);
				$cost[$key] = '<img src="' . $url . '" alt="">';
			}
		}
